...
export const MEMORY_REGION_COPY = {
  hippocampus: {
    ...
    faqs: [
      {
        question: "What is the main function of the hippocampus?",
        answer:
      ...
      {
        question: "What did patient H.M. teach us?",
        answer:
  ...
  "entorhinal-cortex": {
    description:
      "Explore entorhinal cortex anatomy, grid cells and hippocampal input, with Alzheimer’s relevance, exam tips and a free 3D brain quiz.",
    intro: [
    ...
    faqs: [
      ...
      {
        question: "How does entorhinal cortex connect to the hippocampus?",
        answer:
      ...
      {
        question: "Why is entorhinal cortex important in Alzheimer’s disease?",
        answer:
  ...
  parahippocampal: {
    description:
      "Study parahippocampal gyrus function in scenes and spatial context, with navigation pathways, lesion effects and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the parahippocampal gyrus do?",
        answer:
          "It supports scene recognition, spatial context, topographical memory and associations between objects and the places in which they appear.",
      },
      {
        question: "What is the parahippocampal place area?",
        answer:
          "The PPA is scene-selective parahippocampal cortex that responds strongly to places and spatial layouts, in contrast with fusiform regions that prefer faces.",
      },
      {
        question: "What happens after parahippocampal damage?",
        answer:
          "Damage can cause topographical disorientation and difficulty learning new spatial layouts even when basic vision and object recognition remain available.",
      },
    ],
    relatedSlugs: [
      "entorhinal-cortex",
  ...
  "perirhinal-cortex": {
    description:
      "Learn perirhinal cortex function in item familiarity, its route into hippocampal memory and the key recognition contrast in a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the perirhinal cortex do?",
        answer:
          "It supports item recognition, object knowledge and graded familiarity—the sense that something has been encountered even without recovery of its original context.",
      },
      {
        question:
          "How is perirhinal familiarity different from hippocampal recollection?",
        answer:
          "Familiarity is a gradual strength signal for the item itself; recollection is a more threshold-like recovery of contextual details about an episode.",
      },
      {
        question: "Where does perirhinal cortex send object information?",
        answer:
          "It projects toward entorhinal cortex, which provides a major interface with the hippocampus, forming the medial temporal “what” route into episodic memory.",
      },
    ],
  ...
  "dentate-gyrus": {
    description:
      "Explore dentate gyrus function in pattern separation and hippocampal input, with neurogenesis, clinical links and a free brain-region quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the dentate gyrus do?",
        answer:
      ...
      {
        question: "Where does the dentate gyrus receive input from?",
        answer:
          "It receives entorhinal input through the perforant path and sends sparse, powerful mossy-fibre projections to CA3.",
      },
      {
        question: "Does adult neurogenesis occur in the dentate gyrus?",
        answer:
  ...
  ca1: {
    description:
      "Study CA1 hippocampal function, Schaffer collateral input and LTP, with ischemic vulnerability, exam tips and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does hippocampal CA1 do?",
        answer:
      ...
      {
        question: "Which pathway connects CA3 to CA1?",
        answer:
      ...
      {
        question: "Why is CA1 clinically vulnerable?",
        answer:
  ...
  ca3: {
    description:
      "Learn CA3 hippocampal function in pattern completion, recurrent circuits and memory retrieval, with contrasts and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does hippocampal CA3 do?",
        answer:
          "CA3 supports pattern completion, retrieving a fuller stored representation from a partial cue through its recurrent autoassociative connections.",
      },
      {
        question: "Which pathways enter and leave CA3?",
        answer:
          "Dentate gyrus reaches CA3 through mossy fibres, and CA3 reaches CA1 through Schaffer collaterals. CA3 neurons also connect recurrently with one another.",
      },
      {
        question: "How are CA3 and dentate gyrus different?",
        answer:
          "Dentate gyrus emphasizes pattern separation for distinct encoding; CA3 emphasizes pattern completion for retrieval from incomplete information.",
      },
    ],
  ...
  "left-anterior-temporal": {
    description:
      "Explore left anterior temporal function as a semantic hub, with dementia contrasts, memory connections and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the left anterior temporal lobe do?",
        answer:
          "It acts as an amodal semantic hub, integrating visual, auditory, verbal and other features into conceptual knowledge and supporting semantic priming.",
      },
      {
        question: "What is semantic dementia?",
        answer:
          "It is a progressive loss of conceptual and word knowledge associated with anterior temporal atrophy. Patients may recognize that an object is visible yet no longer know its name or use.",
      },
      {
        question: "How does semantic dementia differ from hippocampal amnesia?",
        answer:
          "Semantic dementia initially erodes facts and concepts while episodic experiences can be relatively preserved; hippocampal damage chiefly impairs formation and recollection of episodes.",
      },
    ],
