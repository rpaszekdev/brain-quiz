...
export const BRAINSTEM_REGION_COPY = {
  brainstem: {
    description:
      "Learn brainstem anatomy, vital functions and classic stroke syndromes, with cranial-nerve pathways, exam tips and a free 3D brain quiz.",
    intro: [
  ...
  "facial-nucleus": {
    description:
      "Explore facial nucleus anatomy, voluntary and emotional smile pathways, with Bell’s palsy localization and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the facial nucleus control?",
        answer:
      ...
      {
        question: "Why is the forehead spared in many cortical strokes?",
        answer:
  ...
  "medullary-pyramids": {
    description:
      "Study medullary pyramids, corticospinal decussation and side-of-lesion rules, with motor pathways, exam tips and a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What are the medullary pyramids?",
        answer:
      ...
      {
        question: "What happens at the pyramidal decussation?",
        answer:
      ...
      {
        question: "How does the decussation change weakness localization?",
        answer:
  ...
  "inferior-olive": {
    description:
      "Learn inferior olive function, climbing-fiber error signals and cerebellar motor learning, with clinical relevance and a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the inferior olive do?",
        answer:
      ...
      {
        question: "What are climbing fibres?",
        answer:
      ...
      {
        question: "How do climbing and mossy fibres differ?",
        answer:
  ...
  "spinal-cord": {
    description:
      "Explore spinal cord motor circuits, corticospinal tracts and reflexes, with upper-versus-lower neuron signs and a free anatomy quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What motor functions can the spinal cord perform?",
        answer:
      ...
      {
        question: "What is a central pattern generator?",
        answer:
      ...
      {
        question: "How do upper and lower motor neuron signs differ?",
        answer:
