...
export const FRONTOPARIETAL_REGION_COPY = {
  "prefrontal-cortex": {
    description:
      "Learn the prefrontal cortex’s executive role, connections and clinical signs, then review exam tips and test the anatomy in a free 3D quiz.",
    intro: [
    ...
    faqs: [
      {
        ...
        answer:
          "It supports working memory, planning, cognitive flexibility, impulse control, abstract reasoning and goal-directed behaviour. Different prefrontal subdivisions emphasize cognitive control or emotion-guided decisions.",
      },
      {
        question: "Where is the prefrontal cortex located?",
        answer:
          "It occupies the anterior part of the frontal cortex, in front of premotor and primary motor areas. Its major subdivisions include dorsolateral, ventromedial and frontopolar cortex.",
      },
      {
        question: "What happens after prefrontal cortex damage?",
        answer:
          "Damage can produce a frontal lobe syndrome with poor planning, apathy, disinhibition, impulsivity or altered social judgment, even when language and general intelligence appear relatively intact.",
      },
    ],
  ...
  "orbitofrontal-cortex": {
    description:
      "Explore orbitofrontal cortex function, reward pathways and clinical effects, with focused exam tips and a free interactive brain anatomy quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What is the main function of the orbitofrontal cortex?",
        answer:
          "It represents reward value, predicts outcomes, supports reversal learning and helps emotion guide social and value-based decisions.",
      },
      {
        question:
          "How is the orbitofrontal cortex different from the prefrontal cortex?",
        answer:
          "The orbitofrontal cortex is a prefrontal subdivision with a strong role in valuation and updating stimulus-reward associations. The wider prefrontal cortex also includes systems for working memory, planning and cognitive control.",
      },
      {
        question: "What can orbitofrontal damage cause?",
        answer:
          "It can cause impulsivity, poor social judgment and difficulty changing behaviour after rewards or punishments change. Orbitofrontal dysfunction is also associated with behavioural-variant frontotemporal dementia and OCD.",
      },
    ],
  ...
  "brocas-area": {
    description:
      "Study Broca’s area anatomy, speech-production pathways and aphasia signs, then use the exam tips and free 3D brain-region quiz to practise.",
    intro: [
    ...
    faqs: [
      {
        question: "What does Broca’s area do?",
        answer:
          "It supports speech production, motor programming of speech, grammar and verbal working memory. It also participates in broader hierarchical and action-processing networks.",
      },
      {
        question: "Where is Broca’s area located?",
        answer:
          "It is usually in the left inferior frontal gyrus, principally the pars opercularis and pars triangularis, corresponding to Brodmann areas 44 and 45.",
      },
      {
        question:
          "What is the difference between Broca’s and Wernicke’s aphasia?",
        answer:
          "Broca’s aphasia is typically non-fluent and effortful with relatively better comprehension. Wernicke’s aphasia is fluent but often meaningless, with poor comprehension and reduced awareness of the deficit.",
      },
      {
        question: "What part of the brain controls speech?",
        answer:
          "Broca’s area in the left inferior frontal gyrus programs speech production, while Wernicke’s area in the superior temporal region supports comprehension, and motor cortex drives the muscles that produce sound. Speech is a left-lateralised network in most people, not a single spot.",
      },
    ],
  ...
  "motor-cortex": {
    description:
      "Learn motor cortex location, corticospinal pathways and lesion signs, then review the homunculus and practise with a free interactive 3D quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "Where is the primary motor cortex?",
        answer:
      ...
      {
        question: "What does the motor cortex control?",
        answer:
      ...
      {
        question: "What are the signs of a motor cortex lesion?",
        answer:
  ...
  "premotor-cortex": {
    description:
      "Explore premotor cortex function, motor-planning circuits and apraxia, with clear distinctions, exam tips and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the premotor cortex do?",
        answer:
          "It plans and prepares movements, organizes sequences and converts sensory information into actions. The supplementary motor area contributes to internally generated movement and bimanual coordination.",
      },
      {
        question: "How is premotor cortex different from motor cortex?",
        answer:
          "Premotor regions organize how and when an action should occur; primary motor cortex is more directly involved in executing the voluntary movement through descending motor commands.",
      },
      {
        question: "Can premotor damage cause weakness?",
        answer:
          "Its characteristic deficit is apraxia—impaired performance of learned actions despite enough strength and basic motor capacity. Supplementary motor injury can also cause transient akinesia or mutism.",
      },
    ],
  ...
  "anterior-cingulate": {
    description:
      "Study anterior cingulate cortex function, salience pathways and clinical syndromes, then reinforce the distinctions in a free brain-network quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the anterior cingulate cortex do?",
        answer:
          "It monitors conflict and errors, contributes to the affective component of pain, allocates effort and helps regulate autonomic responses.",
      },
      {
        question: "Which network includes the anterior cingulate cortex?",
        answer:
          "The dorsal anterior cingulate and anterior insula are major hubs of the salience network, which helps identify information that deserves immediate control or attention.",
      },
      {
        question: "What happens after bilateral anterior cingulate damage?",
        answer:
          "Severe bilateral injury can produce akinetic mutism, in which a person is awake but shows little spontaneous movement or speech. Subgenual dysfunction is also linked to mood disorders.",
      },
    ],
  ...
  "somatosensory-cortex": {
    description:
      "Learn somatosensory cortex location, body mapping and cortical sensory loss, then review exam tips and test yourself in a free 3D brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "Where is the somatosensory cortex located?",
        answer:
          "Primary somatosensory cortex lies in the postcentral gyrus of the parietal lobe, just posterior to the central sulcus, and includes Brodmann areas 1, 2 and 3.",
      },
      {
        question: "What does the somatosensory cortex process?",
        answer:
          "It processes touch, pressure, vibration, temperature and proprioceptive information, organized as a somatotopic sensory homunculus.",
      },
      {
        question: "What is a cortical sensory deficit?",
        answer:
          "A patient may detect basic sensation yet fail higher-order tasks such as recognizing an object by touch, called astereognosis. Fine touch and proprioception may also be reduced on the opposite side.",
      },
    ],
  ...
  "parietal-cortex": {
    description:
      "Explore parietal cortex function, attention networks and classic lesion syndromes, then apply the lateralization rules in a free 3D brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the parietal cortex do?",
        answer:
          "It supports spatial awareness, attention, multisensory integration, numerical cognition and the transformation of visual information into reaching or tool-use actions.",
      },
      {
        question: "Why does a right parietal lesion cause neglect?",
        answer:
          "Right parietal attention systems are crucial for representing space. Damage can make the patient fail to attend to the left side even though early visual and sensory pathways may still carry information.",
      },
      {
        question: "What is Gerstmann syndrome?",
        answer:
          "It is a dominant parietal syndrome classically combining agraphia, acalculia, finger agnosia and left-right confusion, often associated with the left angular gyrus.",
      },
    ],
  ...
  "angular-gyrus": {
    description:
      "Study angular gyrus function in reading, number and meaning, with Gerstmann syndrome, exam-ready facts and a free interactive brain-region quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the angular gyrus do?",
        answer:
          "It contributes to reading, arithmetic, semantic integration, theory of mind and default-mode processing by combining information across sensory and conceptual systems.",
      },
      {
        question: "Where is the angular gyrus located?",
        answer:
          "It is part of the inferior parietal lobule near the temporoparietal junction and corresponds mainly to Brodmann area 39.",
      },
      {
        question: "Which syndrome is linked to the angular gyrus?",
        answer:
          "A left angular gyrus lesion is classically associated with Gerstmann syndrome: agraphia, acalculia, finger agnosia and left-right confusion.",
      },
    ],
  ...
  "frontal-eye-fields": {
    description:
      "Learn frontal eye field location, saccade circuits and evidence accumulation, then connect cortex to colliculus in a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What do the frontal eye fields do?",
        answer:
      ...
      {
        question: "Where are the frontal eye fields?",
        answer:
      ...
      {
        question: "What happens after a frontal eye field lesion?",
        answer:
  ...
  "left-inferior-frontal": {
    description:
      "Explore left inferior frontal function in deep encoding and language, with memory pathways, clinical effects and a free brain-area quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does the left inferior frontal gyrus do in memory?",
        answer:
      ...
      {
        question: "How can left inferior frontal damage affect learning?",
        answer:
  ...
  "right-dlpfc": {
    description:
      "Study right dorsolateral prefrontal function in memory checking, false alarms and retrieval networks, then test the anatomy in a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question:
          "What does the right dorsolateral prefrontal cortex do during retrieval?",
        answer:
          "It monitors retrieved information, checks accuracy and relevance, and helps reject false memories. Activity is often greater for uncertain, low-confidence decisions.",
      },
      {
        question: "How is right DLPFC different from the hippocampus?",
        answer:
          "The hippocampus is central to forming and recovering episodic content; right DLPFC evaluates that output and supports controlled decisions about whether it is trustworthy.",
      },
      {
        question: "What can a right DLPFC lesion do to recognition memory?",
        answer:
          "It can increase false alarms, so unfamiliar items are more often accepted as remembered. The deficit reflects impaired monitoring rather than total loss of stored information.",
      },
    ],
  ...
  "right-frontopolar": {
    description:
      "Learn right frontopolar cortex function in retrieval mode, its memory-network connections and the key exam distinction in a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What is retrieval mode?",
        answer:
          "Retrieval mode is a sustained cognitive state oriented toward searching memory. Right frontopolar cortex helps maintain it across a task rather than signaling whether one specific item was remembered.",
      },
      {
        question: "Where is the right frontopolar cortex?",
        answer:
          "It is at the most anterior part of the right prefrontal cortex and is associated with Brodmann area 10.",
      },
      {
        question: "How does retrieval mode differ from retrieval success?",
        answer:
          "Retrieval mode is sustained and frontopolar; retrieval success is a transient response involving structures such as the hippocampus and parietal cortex when a particular memory is recovered.",
      },
    ],
  ...
  "ventral-ppc": {
    description:
      "Explore ventral posterior parietal function in recollection and bottom-up attention, including the encoding-retrieval flip and a free brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does ventral posterior parietal cortex do in memory?",
        answer:
          "It supports bottom-up attention to retrieved content, especially vivid recollection. In the Attention to Memory model, a recovered memory itself captures attention.",
      },
      {
        question: "What is the encoding-retrieval flip?",
        answer:
          "Ventral parietal activity can be negatively related to successful encoding but positively related to successful retrieval, reflecting distraction during learning and attention capture during recollection.",
      },
      {
        question: "How does ventral PPC differ from dorsal PPC?",
        answer:
          "Ventral PPC is associated with attention captured by memories; dorsal PPC supports deliberate, top-down searching for memories and graded familiarity judgments.",
      },
    ],
  ...
  "dorsal-ppc": {
    description:
      "Study dorsal posterior parietal function in top-down memory search and familiarity, with network contrasts and a free interactive brain quiz.",
    intro: [
    ...
    faqs: [
      {
        question: "What does dorsal posterior parietal cortex do?",
        answer:
          "It supports voluntary, top-down attention during memory search and can represent graded familiarity or memory strength when retrieval is difficult.",
      },
      {
        question: "Where is dorsal PPC located?",
        answer:
          "It is in superior posterior parietal cortex, associated particularly with the superior parietal lobule and Brodmann area 7.",
      },
      {
        question: "How is dorsal PPC different from ventral PPC?",
        answer:
          "Dorsal PPC helps search for memories under top-down control. Ventral PPC responds when recollected information captures attention from the bottom up.",
      },
    ],
